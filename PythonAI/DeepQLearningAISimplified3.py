...
class DeepQLearningAISimplified3(AIInterface):
    def __init__(self):
        super().__init__()
...
class DQN(nn.Module):
    ...
    def __init__(self, actions, obsv_width, obsv_height):
        ...
        self.fc1 = nn.Linear(128 * self.pre_linear_width * self.pre_linear_height, 256)  # Adjust the input features based on the output of the last pooling layer
